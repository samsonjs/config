...
# 1. Environment Vars
# ===================
custom_paths=(/sbin /usr/sbin /Library/Developer/Toolchains/swift-latest.xctoolchain/usr/bin /Applications/Xcode.app/Contents/Developer/usr/bin /usr/local/bin /usr/local/sbin $HOME/bin)
